...
from Keyboards.InlineKeyboard import photo_like
...
async def handle_photo(message: Message):
    ...
    await message.answer(escaped_text, parse_mode=ParseMode.MARKDOWN_V2, reply_markup = photo_like)


@router_reader_photo.callback_query()
async def handle_photo(message: Message):
    pytesseract.pytesseract.tesseract_cmd = TESSERACT_CMD
    photo = message.photo[-1]
    bot = message.bot
